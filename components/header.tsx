...
export function Header({ withSettings, hideNav, id }: { withSettings?: boolean, hideNav?: boolean, id?: string }) {
      ...
      >
        ...
        {!isAppPage && (
           <nav className="hidden md:flex items-center gap-6">
             <a href="/#features" className="relative text-foreground/80 hover:text-foreground transition-all duration-300 group px-3 py-1 rounded-lg hover:bg-foreground/5">Features</a>
             <a href="/#pricing" className="relative text-foreground/80 hover:text-foreground transition-all duration-300 group px-3 py-1 rounded-lg hover:bg-foreground/5">Pricing</a>
             <a href="/security" className="relative text-foreground/80 hover:text-foreground transition-all duration-300 group px-3 py-1 rounded-lg hover:bg-foreground/5">Security</a>
             <a href="/integrations" className="relative text-foreground/80 hover:text-foreground transition-all duration-300 group px-3 py-1 rounded-lg hover:bg-foreground/5">Integrations</a>
             <a href="/about" className="relative text-foreground/80 hover:text-foreground transition-all duration-300 group px-3 py-1 rounded-lg hover:bg-foreground/5">About</a>
           </nav>
        )}
        ...
        <div className="flex items-center gap-3">
          {isAppPage ? (
            ...
            <Button onClick={handleLogout} variant="ghost" size='sm' className="text-foreground/80 hover:text-foreground hover:bg-foreground/10 hidden md:flex">
            ...
            <>
              <Link href="/login">
                <Button variant="ghost" size="sm" className="text-foreground/80 hover:text-foreground hover:bg-foreground/10 transition-all duration-200 rounded-xl hidden md:flex">Sign In</Button>
              </Link>
              <Link href="/signup">
                <Button size="sm" className="bg-black hover:bg-gray-900 text-white border border-white transform transition-all duration-200 hover:scale-105 hover:shadow-lg rounded-xl hidden md:flex">Get Started</Button>
              </Link>
            </>
          )}
